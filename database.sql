...
(
  ...
  CONSTRAINT event_trip_pkey PRIMARY KEY (id_event, id_trip),
  CONSTRAINT event_trip_relation_ibfk_1 FOREIGN KEY (id_event)
      REFERENCES event (id) MATCH SIMPLE
      ON UPDATE RESTRICT ON DELETE RESTRICT,
  CONSTRAINT event_trip_relation_ibfk_2 FOREIGN KEY (id_trip)
...
(
  ...
  id_trip integer NOT NULL,
  CONSTRAINT poi_trip_pkey PRIMARY KEY (id_poi, id_trip),
  CONSTRAINT poi_trip_relation_ibfk_1 FOREIGN KEY (id_poi)
      REFERENCES poi (id) MATCH SIMPLE
      ON UPDATE RESTRICT ON DELETE RESTRICT,
  CONSTRAINT poi_trip_relation_ibfk_2 FOREIGN KEY (id_trip)
      REFERENCES trip (id) MATCH SIMPLE
      ON UPDATE RESTRICT ON DELETE RESTRICT
)
WITH (OIDS=FALSE);
